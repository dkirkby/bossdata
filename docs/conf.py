...
# -*- coding: utf-8 -*-
#
# bossdata documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'bossdata.tex', 'bossdata Documentation',
     'David Kirkby', 'manual'),
]
...
man_pages = [
    (master_doc, 'bossdata', 'bossdata Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bossdata', 'bossdata Documentation',
     author, 'bossdata', 'One line description of project.',
     'Miscellaneous'),
]
...
import bossdata # for the relpath below
